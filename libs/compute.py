...
def data_loader(opt):
    ...
    testset_gt = torchvision.datasets.ImageFolder(root= data_root + '/Expert-C/Testing/', transform=transform)
    trainset_1_gt = torchvision.datasets.ImageFolder(root= data_root + '/Expert-C/Training1/', transform=transform)
    trainset_2_gt = torchvision.datasets.ImageFolder(root= data_root + '/Expert-C/Training2/', transform=transform)

    testset_inp = torchvision.datasets.ImageFolder(root= data_root+ '/input/Testing/', transform=transform)
    trainset_1_inp = torchvision.datasets.ImageFolder(root= data_root + '/input/Training1/', transform=transform)
    trainset_2_inp = torchvision.datasets.ImageFolder(root= data_root + '/input/Training2/', transform=transform)
